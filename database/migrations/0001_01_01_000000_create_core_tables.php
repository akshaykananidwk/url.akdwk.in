...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('role', 20)->default('user')->index(); // user | admin | staff
            $table->json('permissions')->nullable();              // staff admin permissions
            $table->foreignId('plan_id')->nullable()->index();
            $table->string('plan_cycle', 20)->nullable();         // monthly | yearly | lifetime
            ...
            $table->decimal('affiliate_balance', 12, 2)->default(0);
